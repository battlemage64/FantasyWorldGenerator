...
TERRAIN_TYPES = {"all":("Valley", "Mountains", "Plain", "Hills", "Forest", "Island", "Archipelago", "Coast", "River", "Lake", "Ridge", "Plateau", "Marsh", "Marshes", "Swamp", "Grasslands")} # gives terrain name with genTerrain()
